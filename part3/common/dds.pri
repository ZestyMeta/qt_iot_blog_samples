...
ddsgen.commands = $${RTIDDS_PREFIX}/bin/rtiddsgen -language c++11 -d $${OUT_PWD} ${QMAKE_FILE_NAME}

ddsheadergen.output = $${OUT_PWD}/${QMAKE_FILE_IN_BASE}.hpp
...
ddsplugingen.output = $${OUT_PWD}/${QMAKE_FILE_IN_BASE}ImplPlugin.cxx
...
ddspluginheadergen.output = $${OUT_PWD}/${QMAKE_FILE_IN_BASE}ImplPlugin.hpp
...
ddssupportgen.output = $${OUT_PWD}/${QMAKE_FILE_IN_BASE}Impl.cxx
...
ddssupportheadergen.output = $${OUT_PWD}/${QMAKE_FILE_IN_BASE}Impl.hpp
...
RTIDDS_INCLUDES = $${RTIDDS_PREFIX}/include $${RTIDDS_PREFIX}/include/ndds $${RTIDDS_PREFIX}/include/ndds/hpp

INCLUDEPATH += $${RTIDDS_INCLUDES}
DEPENDPATH += $${RTIDDS_INCLUDES}
LIBS += -L$${RTIDDS_PREFIX}/lib/$${RTIDDS_VERSION} -lnddscd -lnddscpp2d -lnddscored
